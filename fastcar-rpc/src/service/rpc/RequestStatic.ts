 ...
 */
export const ClientRequestStatic = async <T extends Object, K extends Object>(res: { client: RpcClient; url: string; data?: T; opts?: RetryConfig }): Promise<K> => {
 ...
 */
export const ServerRequestStatic = async <T extends Object, K extends Object>(res: { sessionId: SessionId; client: RpcServer; url: string; data?: T; opts?: RetryConfig }): Promise<K> => {

...
function DSInjection(read = true) {
    return function (target, name, descriptor) {
        ...
        const dsIndex = Reflect.getMetadata(DesignMeta_1.DesignMeta.dsIndex, target, name);
        ...
        descriptor.value = function (...args) {
            ...
            if (!dsName) {
                let fnDefaultDS = Reflect.getMetadata(DesignMeta_1.DesignMeta.ds, target, name);
                let classDefaultDS = Reflect.getMetadata(DesignMeta_1.DesignMeta.ds, target);
